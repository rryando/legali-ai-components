  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className="absolute top-0 left-1/4 w-[800px] h-[800px] bg-gradient-to-br from-[#667eea]/20 via-[#764ba2]/10 to-transparent rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "8s", transform }}
        />
        <div
          className="absolute top-1/3 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-[#4eaed0]/25 via-[#06b6d4]/15 to-transparent rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "6s", animationDelay: "2s", transform }}
        />
        <div
          className="absolute bottom-0 left-0 w-[700px] h-[700px] bg-gradient-to-tr from-[#f472b6]/15 via-[#ec4899]/10 to-transparent rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "10s", animationDelay: "1s", transform }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-gradient-to-tl from-[#a78bfa]/15 to-transparent rounded-full blur-3xl animate-pulse"
