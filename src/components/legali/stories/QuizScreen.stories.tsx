...
const sampleQuestions = [
  {
    ...
    answers: [
      ...
      {
        id: 3,
        text: "C) Discovering new evidence during trial",
        correct: false,
      },
      { id: 4, text: "D) Looking up legal definitions", correct: false },
    ],
    explanation:
      "Discovery is the pre-trial process where both sides exchange information and evidence. This helps ensure fair trials by reducing surprises.",
  },
  {
    id: 2,
    ...
    explanation:
      "Interrogatories are written questions that must be answered under oath. They're one of several discovery tools used to gather information.",
  },
  {
    id: 3,
    ...
    explanation:
      "Most jurisdictions give you 30 days to respond to discovery requests, though this can vary by state and type of discovery.",
  },
  {
    id: 4,
    ...
    answers: [
      {
        id: 1,
        text: "A) Yes, if they're improper or overly broad",
        correct: true,
      },
    ...
    explanation:
      "You can object to discovery requests that are overly broad, irrelevant, privileged, or not reasonably calculated to lead to admissible evidence.",
  },
  {
    id: 5,
    ...
    answers: [
      ...
      {
        id: 3,
        text: "C) The judge can sanction you or strike your pleadings",
        correct: true,
      },
      { id: 4, text: "D) You automatically win", correct: false },
    ],
    explanation:
      "Ignoring discovery is serious! The court can impose sanctions, which may include monetary penalties, striking your claims or defenses, or even dismissing your case.",
  },
];
