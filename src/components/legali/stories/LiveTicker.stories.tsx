  ...
  render: () => (
    <div style={{ height: '100vh', position: 'relative' }}>
      ...
      <div className="p-8 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Live Ticker Demo</h1>
...
export const CustomNotifications: Story = {
  args: {
    notifications: [
      { name: 'John D.', location: 'London', action: 'signed up for a free trial' },
  ...
  render: (args) => (
    <div style={{ height: '100vh', position: 'relative' }}>
      <LiveTicker {...args} />
      <div className="p-8 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Custom Notifications</h1>
        <p className="text-slate-600">
...
export const SlowerRotation: Story = {
  ...
  render: (args) => (
    <div style={{ height: '100vh', position: 'relative' }}>
      <LiveTicker {...args} />
      <div className="p-8 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Slower Rotation</h1>
        <p className="text-slate-600">
