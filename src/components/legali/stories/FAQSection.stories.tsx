    ...
    faqs: [
      {
        ...
        answer:
          "Simply create an account and start uploading your documents or describing your legal situation.",
      },
      {
