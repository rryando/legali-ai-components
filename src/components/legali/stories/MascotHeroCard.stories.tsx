...
export const Default: Story = {
  args: {
    ...
    script: baseScript,
    stream: { fitToStepDuration: true, loop: true, showCursor: true, linePauseMs: 3000 },
  },
}
...
export const InterruptDemo: Story = {
  ...
  args: {
    ...
    script: baseScript,
    interruptScript: [
      { motion: MascotMotion.THINKING, durationMs: 450, lines: ["Hmm…", "One moment"] },
      { motion: MascotMotion.SPEAKING, durationMs: 2500, lines: ["Okay — switching focus."] },
