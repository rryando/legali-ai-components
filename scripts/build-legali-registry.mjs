...
const files = [
  ...
  { name: "legali-lib-utils", type: "registry:lib", files: ["lib/utils.ts"], dependencies: ["clsx", "tailwind-merge"] },
  { name: "legali-style-globals", type: "registry:style", files: ["styles/globals.css"] },
  { name: "legali-hook-use-mobile", type: "registry:hook", files: ["hooks/use-mobile.ts"] },

  // Shared base UI pieces (prefixed)
  { name: "legali-button", type: "registry:ui", files: ["components/ui/legali/button.tsx"], dependencies: ["class-variance-authority", "clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-avatar", type: "registry:ui", files: ["components/ui/legali/avatar.tsx"], dependencies: ["@radix-ui/react-avatar"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-badge", type: "registry:ui", files: ["components/ui/legali/badge.tsx"], dependencies: ["class-variance-authority", "clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-switch", type: "registry:ui", files: ["components/ui/legali/switch.tsx"], dependencies: ["@radix-ui/react-switch"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-chart", type: "registry:ui", files: ["components/ui/legali/chart.tsx"], dependencies: ["recharts"], registryDependencies: ["legali-lib-utils"] },
  ...
  { name: "legali-stat-row", type: "registry:ui", files: ["components/ui/legali/atomic/StatRow.tsx"], dependencies: ["clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-status-bar", type: "registry:ui", files: ["components/ui/legali/atomic/StatusBar.tsx"], dependencies: ["clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-explanation-card", type: "registry:ui", files: ["components/ui/legali/atomic/ExplanationCard.tsx"], dependencies: ["clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils", "legali-glass-card"] },
  { name: "legali-question-number-badge", type: "registry:ui", files: ["components/ui/legali/atomic/QuestionNumberBadge.tsx"], dependencies: ["clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils"] },
  { name: "legali-setting-item", type: "registry:ui", files: ["components/ui/legali/atomic/SettingItem.tsx"], dependencies: ["lucide-react"], registryDependencies: ["legali-switch"] },
  { name: "legali-profile-stat-card", type: "registry:ui", files: ["components/ui/legali/atomic/ProfileStatCard.tsx"], dependencies: ["lucide-react", "clsx", "tailwind-merge"], registryDependencies: ["legali-lib-utils", "legali-glass-card"] },
  ...
  { name: "legali-quiz-header", type: "registry:ui", files: ["components/ui/legali/composite/QuizHeader.tsx"], dependencies: ["lucide-react", "clsx", "tailwind-merge"], registryDependencies: ["legali-progress-bar", "legali-lib-utils"] },
  ...
  { name: "legali-progress-screen", type: "registry:ui", files: ["components/ui/legali/screens/ProgressScreen.tsx"], dependencies: ["lucide-react", "clsx", "tailwind-merge", "recharts"], registryDependencies: ["legali-glass-card", "legali-lib-utils", "legali-chart"] },
  { name: "legali-profile-screen", type: "registry:ui", files: ["components/ui/legali/screens/ProfileScreen.tsx"], dependencies: ["lucide-react", "clsx", "tailwind-merge"], registryDependencies: ["legali-glass-card", "legali-profile-stat-card", "legali-setting-item", "legali-avatar", "legali-badge", "legali-button", "legali-lib-utils"] },

  // Mascot
  { name: "legali-mascot", type: "registry:ui", files: ["components/ui/legali/mascot/LegaliMascot.tsx", "components/ui/legali/mascot/index.ts", "components/ui/legali/mascot/RiveGuide.mdx"], dependencies: ["@rive-app/react-canvas"] },
